...
| `@radix-ui/react-checkbox` | `^1.3.5` | `my-react-shell/components` |
| `@radix-ui/react-switch` | `^1.3.1` | `my-react-shell/components` |
| `@radix-ui/react-radio-group` | `^1.4.1` | `my-react-shell/components` |
| `@radix-ui/react-tooltip` | `^1.2.10` | `my-react-shell/components` |
| `@radix-ui/react-tabs` | `^1.1.15` | `my-react-shell/components` |
