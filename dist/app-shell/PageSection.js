 ...
 */
export function PageSection({ title, icon, actions, className, children, }) {
    ...
    return (_jsxs("div", { className: `mrs-section__card${className ? ` ${className}` : ''}`, children: [_jsxs("div", { className: "mrs-section__head", children: [resolvedIcon, typeof title === 'string' ? (_jsx("h3", { className: "mrs-section__title", children: title })) : (title), actions && actions.length > 0 && (_jsx("div", { className: "mrs-section__actions", children: actions.map((act, i) => (_jsx("span", { children: act }, i))) }))] }), _jsx("div", { className: "mrs-section__body", children: children })] }));
}
