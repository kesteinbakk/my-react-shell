 ...
 */
export declare function setupScrollspy(container: HTMLElement, sectionRefs: Map<string, HTMLElement>, hooks: ScrollspyHooks): () => void;
 ...
 */
export declare function scrollToSection(opts: ScrollToOptions): void;
