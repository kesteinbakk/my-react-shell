 ...
 * `value` / `onValueChange`.
 */
export function Select({ options, value, onValueChange, placeholder = 'Select…', disabled, className, ...rest }) {
    return (_jsxs(RadixSelect.Root, { value: value, onValueChange: onValueChange, disabled: disabled, children: [_jsxs(RadixSelect.Trigger, { className: cn('mrs-select__trigger', className), "aria-label": rest['aria-label'], children: [_jsx(RadixSelect.Value, { placeholder: placeholder }), _jsx(RadixSelect.Icon, { className: "mrs-select__chevron", children: chevron })] }), _jsx(RadixSelect.Portal, { children: _jsx(RadixSelect.Content, { className: "mrs-select__content", position: "popper", sideOffset: 4, children: _jsx(RadixSelect.Viewport, { className: "mrs-select__viewport", children: options.map((opt) => (_jsxs(RadixSelect.Item, { value: opt.value, disabled: opt.disabled, className: "mrs-select__item", children: [_jsx("span", { className: "mrs-select__indicator", children: _jsx(RadixSelect.ItemIndicator, { children: check }) }), _jsx(RadixSelect.ItemText, { children: opt.label })] }, opt.value))) }) }) })] }));
}
