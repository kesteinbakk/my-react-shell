...
export function Accordion({ items, type = 'single', collapsible = true, value, defaultValue, onValueChange, variant = 'default', size = 'md', showArrow = true, animationDuration = 200, className, }) {
    ...
    const renderedItems = items.map((item) => (_jsxs(RadixAccordion.Item, { value: item.value, disabled: item.disabled, className: "mrs-accordion__item", children: [_jsxs(RadixAccordion.Header, { className: "mrs-accordion__header", children: [item.actionsStart && (_jsx("div", { className: "mrs-accordion__actions mrs-accordion__actions--start", children: item.actionsStart })), _jsx(RadixAccordion.Trigger, { className: "mrs-accordion__trigger", children: _jsx("span", { className: "mrs-accordion__label", children: item.trigger }) }), (item.actionsEnd || showArrow) && (_jsxs("div", { className: "mrs-accordion__trigger-end", children: [item.actionsEnd && (_jsx("div", { className: "mrs-accordion__actions mrs-accordion__actions--end", children: item.actionsEnd })), showArrow && (_jsx("span", { className: "mrs-accordion__chevron", "aria-hidden": "true", children: chevronDown }))] }))] }), _jsx(RadixAccordion.Content, { className: "mrs-accordion__content", children: _jsx("div", { className: "mrs-accordion__body", children: item.content }) })] }, item.value)));
