 ...
 */
export function UserPreferences({ theme, themes, onThemeChange, mode, onModeChange, followSystem, onFollowSystemChange, iconMode, onIconModeChange, menuSize, onMenuSizeChange, accountActions, trigger, open, onOpenChange, sections, activeSection, onActiveSectionChange, triggerLabel, title, description, themeHeading, modeHeading, displayHeading, lightLabel, darkLabel, systemLabel, iconsLabel, emojisLabel, menuSizeHeading, menuSizeMediumLabel, menuSizeLargeLabel, menuSizeXlargeLabel, closeLabel, className, }) {
    ...
    const displayPane = showDisplay || showMenuSize ? (_jsxs(_Fragment, { children: [showDisplay && (_jsxs("section", { className: "mrs-prefs__section", children: [_jsx("h3", { className: "mrs-prefs__heading", children: displayHeading }), _jsxs("div", { className: "mrs-prefs__seg", role: "group", "aria-label": typeof displayHeading === 'string' ? displayHeading : undefined, children: [_jsxs(Segment, { active: iconMode === 'emoji', onClick: () => onIconModeChange('emoji'), children: [_jsx("span", { className: "mrs-prefs__emoji", "aria-hidden": "true", children: "\uD83D\uDE00" }), emojisLabel] }), _jsxs(Segment, { active: iconMode === 'icon', onClick: () => onIconModeChange('icon'), children: [SmileGlyph, iconsLabel] })] })] })), showMenuSize && (_jsxs("section", { className: "mrs-prefs__section", children: [_jsx("h3", { className: "mrs-prefs__heading", children: menuSizeHeading ?? st('mrs.prefs.menuSizeHeading') }), _jsxs("div", { className: "mrs-prefs__seg", role: "group", "aria-label": typeof menuSizeHeading === 'string' ? menuSizeHeading : st('mrs.prefs.menuSizeHeading'), children: [_jsxs(Segment, { active: menuSize === 'medium', onClick: () => onMenuSizeChange('medium'), children: [_jsx(SizeGlyph, { size: 13 }), menuSizeMediumLabel ?? st('mrs.prefs.menuSizeMedium')] }), _jsxs(Segment, { active: menuSize === 'large', onClick: () => onMenuSizeChange('large'), children: [_jsx(SizeGlyph, { size: 16 }), menuSizeLargeLabel ?? st('mrs.prefs.menuSizeLarge')] }), _jsxs(Segment, { active: menuSize === 'xlarge', onClick: () => onMenuSizeChange('xlarge'), children: [_jsx(SizeGlyph, { size: 19 }), menuSizeXlargeLabel ?? st('mrs.prefs.menuSizeXlarge')] })] })] }))] })) : null;
    ...
    return (_jsxs(Dialog.Root, { open: isOpen, onOpenChange: setOpen, children: [_jsx(Dialog.Trigger, { asChild: true, children: trigger ?? (_jsx("button", { type: "button", className: "mrs-prefs-trigger", "aria-label": triggerLabel, title: triggerLabel, children: _jsx(ModeGlyph, { icon: PaletteGlyph, emoji: "\uD83C\uDFA8", emojiMode: emojiMode }) })) }), _jsxs(Dialog.Portal, { children: [_jsx(Dialog.Overlay, { className: "mrs-dialog__overlay" }), _jsxs(Dialog.Content, { className: cn('mrs-prefs', sectioned && 'mrs-prefs--sectioned', className), children: [_jsxs("div", { className: "mrs-prefs__header", children: [_jsx(Dialog.Title, { className: "mrs-prefs__title", children: title }), _jsx(Dialog.Close, { className: "mrs-prefs__close", "aria-label": closeLabel ?? st('mrs.action.close'), children: _jsx(ModeGlyph, { icon: CloseGlyph, emoji: "\u274C", emojiMode: emojiMode }) })] }), description != null && (_jsx(Dialog.Description, { className: "mrs-prefs__desc", children: description })), sectioned ? (_jsxs("div", { className: "mrs-prefs__panes", children: [_jsx("nav", { className: "mrs-prefs__nav", "aria-label": typeof title === 'string' ? title : undefined, children: navItems.map((item) => {
                                        ...
                                        }) }), _jsx("div", { className: "mrs-prefs__content", children: activeContent })] })) : (_jsxs(_Fragment, { children: [themePane, displayPane] })), accountActions != null && _jsx("div", { className: "mrs-prefs__account", children: accountActions })] })] })] }));
}
