...
export function DropdownMenu({ trigger, items, align = 'center', side = 'bottom', sideOffset = 8, className, }) {
    return (_jsxs(RadixMenu.Root, { children: [_jsx(RadixMenu.Trigger, { asChild: true, children: trigger }), _jsx(RadixMenu.Portal, { children: _jsx(RadixMenu.Content, { className: cn('mrs-menu', className), align: align, side: side, sideOffset: sideOffset, children: items.map((item, i) => renderItem(item, String(i))) }) })] }));
}
