 ...
 * ```
 */
export function Sheet({ children, trigger, open, onOpenChange, defaultOpen, title, header, description, side = 'right', size = 'md', showClose = true, closeLabel = 'Close', scrim = true, modal = true, bare = false, className, overlayClass, panelTestId, }) {
