 ...
 */
export function ColorPicker({ value, onChange, colors, format = 'hex', label, description, align = 'start', placeholder = 'Pick a color', disabled, className, ...rest }) {
    ...
    return (_jsxs("div", { className: cn('mrs-color-picker', className), children: [label != null && _jsx("span", { className: "mrs-color-picker__label", children: label }), description != null && _jsx("p", { className: "mrs-color-picker__desc", children: description }), _jsxs(Popover.Root, { open: open, onOpenChange: setOpen, children: [_jsx(Popover.Trigger, { asChild: true, children: _jsxs("button", { type: "button", className: "mrs-color-picker__trigger", disabled: disabled, "aria-label": ariaLabel, children: [_jsx("span", { className: "mrs-color-picker__preview", "data-empty": isEmpty, style: isEmpty ? undefined : { background: value }, "aria-hidden": "true" }), _jsx("span", { className: "mrs-color-picker__value", "data-placeholder": isEmpty, children: triggerText }), _jsx("span", { className: "mrs-color-picker__caret", children: caretGlyph })] }) }), _jsx(Popover.Portal, { children: _jsx(Popover.Content, { className: "mrs-color-picker__panel", sideOffset: 6, align: align, children: constrained ? (_jsx("div", { className: "mrs-color-picker__swatches", role: "radiogroup", "aria-label": ariaLabel ?? 'Colors', children: colors.map((color, i) => {
