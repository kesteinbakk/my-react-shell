 ...
 */
export function Preview({ open, onOpenChange, title, file, actions, showPrintButton = true, printLabel, closeLabel, loadingLabel, errorLabel, noDataLabel, noFileLabel, className, }) {
