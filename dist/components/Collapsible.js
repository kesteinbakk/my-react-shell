 ...
 * `Accordion` instead.
 */
export function Collapsible({ expanded, defaultExpanded = false, onExpandedChange, trigger, renderTrigger, children, showArrow = true, animationDuration = 200, disabled, variant, size, inlineChevron = false, className, triggerClassName, contentClassName, arrowClassName, }) {
    ...
    return (_jsxs(RadixCollapsible.Root, { open: open, onOpenChange: handleOpenChange, disabled: disabled, className: cn('mrs-collapsible', className), children: [_jsxs(RadixCollapsible.Trigger, { className: cn(triggerVariants({ variant, size, layout: inlineChevron ? 'inline' : 'spread' }), triggerClassName), children: [_jsx("span", { className: "mrs-collapsible__label", children: renderTrigger ? renderTrigger(open) : trigger }), showArrow && (_jsx("span", { className: cn('mrs-collapsible__chevron', open && 'mrs-collapsible__chevron--open', arrowClassName), "aria-hidden": "true", children: chevronDown }))] }), _jsx(RadixCollapsible.Content, { className: cn('mrs-collapsible__content', contentClassName), style: contentStyle, children: _jsx("div", { className: "mrs-collapsible__body", children: children }) })] }));
}
