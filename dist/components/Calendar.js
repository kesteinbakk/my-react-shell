...
function MrsChevron({ orientation = 'left', className }) {
    // One chevron path, rotated by orientation.
    const rotate = { left: 0, right: 180, up: 90, down: 270 }[orientation];
    return (_jsx("svg", { width: 16, height: 16, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", className: className, style: { transform: `rotate(${rotate}deg)` }, children: _jsx("path", { d: "m15 18-6-6 6-6" }) }));
}
/**
...
export function Calendar({ className, classNames, components, showOutsideDays = true, ...props }) {
    return (_jsx(DayPicker, { showOutsideDays: showOutsideDays, className: cn('mrs-calendar', className), classNames: { ...MRS_CLASSNAMES, ...classNames }, components: { Chevron: MrsChevron, ...components }, ...props }));
}
