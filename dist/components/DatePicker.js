 ...
 * ```
 */
export function DatePicker({ value, defaultValue, onChange, placeholder = 'Pick a date', displayFormat = 'PP', disabledDays, startMonth, endMonth, disabled, className, ...rest }) {
