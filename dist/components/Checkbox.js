 ...
 * ```
 */
export function Checkbox({ checked, defaultChecked, onCheckedChange, disabled, required, name, value, id, className, ...rest }) {
    return (_jsx(RadixCheckbox.Root, { checked: checked, defaultChecked: defaultChecked, onCheckedChange: onCheckedChange, disabled: disabled, required: required, name: name, value: value, id: id, "aria-label": rest['aria-label'], className: cn('mrs-checkbox', className), children: _jsxs(RadixCheckbox.Indicator, { className: "mrs-checkbox__indicator", children: [_jsx("span", { className: "mrs-checkbox__check", children: check }), _jsx("span", { className: "mrs-checkbox__dash", children: dash })] }) }));
}
