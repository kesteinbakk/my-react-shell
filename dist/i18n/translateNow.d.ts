...
export declare function setActiveTranslator(translator: TFunction | null): void;
/**
 ...
 */
export declare function translateNow<K extends string = string>(key: K, params?: TranslateParams): string;
