...
export const SHELL_CATALOG_FLAT = Object.fromEntries(Object.entries(SHELL_CATALOG).map(([code, msgs]) => [code, flattenMessages(msgs)]));
/**
 ...
 */
export function withShellCatalog(messages) {
    const out = {};
    for (const code of Object.keys(messages)) {
        const base = SHELL_CATALOG[code] ?? SHELL_CATALOG[DEFAULT_SHELL_LOCALE];
        out[code] = mergeMessages(base, messages[code]);
    }
    return out;
}
