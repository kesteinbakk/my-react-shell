...
export declare function I18nProvider({ children, messages, locales: localesProp, defaultLocale, fallbackLocale: fallbackLocaleProp, detectBrowserLocale, storageKey, resolve, onMissingKey, debug, }: I18nProviderProps): import("react").JSX.Element;
