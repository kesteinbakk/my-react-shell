 ...
 */
export type NamespacedKeys<K extends string, NS extends string> = string extends K ? string : K extends `${NS}.${infer Rest}` ? Rest : never;
...
export declare function useTranslation<K extends string = string>(namespace?: string): UseTranslationResult<K>;
