...
export function EmojiRenderProvider({ children, render }: EmojiRenderProviderProps) {
  ...
  const value = useMemo<EmojiRenderer>(() => render, [render])
  return <EmojiRenderContext.Provider value={value}>{children}</EmojiRenderContext.Provider>
}
