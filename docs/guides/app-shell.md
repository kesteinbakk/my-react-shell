...
| `pageContainer.defaultMaxWidth` | `narrow` (1000px) · `medium` (1200px) · `wide` (1400px - fits 4 cards) · `x-wide` (1600px) · `full` | `x-wide` | Max width of the centered page-content container (`full` = edge-to-edge). |
